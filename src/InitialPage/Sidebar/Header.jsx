              ...
              <span className="user-info">
                ...
                <span className="user-detail">
                  <span className="user-name">
                    {loading ? "Loading..." : (selectedStore ? branches.find(b => b.id === selectedStore)?.name : "Utama (Semua)")}
                  </span>
                </span>
              </span>
            </Link>
            <div className="dropdown-menu dropdown-menu-right">
              <Link to="#" className="dropdown-item" onClick={(e) => { e.preventDefault(); setSelectedStore(null); }}>
                <ImageWithBasePath src="assets/img/store/store-01.png" alt="Store Logo" className="img-fluid" /> Utama (Semua)
              </Link>
              {branches.map((branch, idx) => (
                <Link key={branch.id} to="#" className="dropdown-item" onClick={(e) => { e.preventDefault(); setSelectedStore(branch.id); }}>
                  <ImageWithBasePath src={`assets/img/store/store-0${(idx%4)+1}.png`} alt="Store Logo" className="img-fluid" /> {branch.name}
                </Link>
              ))}
            </div>
          </li>
